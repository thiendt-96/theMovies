...
## Description
- folder apis: chứa các file gọi api được dùng trong project.
- folder components: chứa các component của project.
- folder Pages: chứa các page của project.
- folder images: chứa tất cả các hình ảnh sử dụng trong project
- folder scss: chứa file .scss viết style cho project.
- folder selectors: chứa các các bộ chọn với dữ liệu .
